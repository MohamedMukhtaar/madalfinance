-- =====================================================================
-- ICT Solutions Finance Management System — Full Database Schema
-- Engine: MySQL 8.0+ | Charset: utf8mb4 | Storage: InnoDB
-- Run this whole file in one go (e.g. `mysql -u root -p < finance_system_schema.sql`)
-- =====================================================================
...
CREATE TABLE users (
  ...
  password    VARCHAR(255) NOT NULL,               -- store a hash (bcrypt/argon2), never plain text
...
CREATE TABLE project_types (
  ...
  type_name        VARCHAR(50) NOT NULL UNIQUE   -- 'One Time' | 'Rental'
) ENGINE=InnoDB;
...
CREATE TABLE transactions (
  ...
  reference_type    VARCHAR(50) NOT NULL,   -- e.g. 'Payment','Expense','Other Income','Member Due','Invoice Adjustment'
  reference_id      INT NOT NULL,           -- id in the referenced table (polymorphic, no FK constraint)
  description       VARCHAR(255),
...
-- =====================================================================
-- SEED DATA (safe to remove if you only want the empty schema)
-- =====================================================================

INSERT INTO roles (role_name) VALUES ('Super Admin'), ('Finance Admin'), ('Member');

INSERT INTO project_types (type_name) VALUES ('One Time'), ('Rental');

INSERT INTO income_categories (category_name) VALUES
  ('Rental'), ('Project'), ('Hosting'), ('Maintenance'), ('Consultation'), ('Training'), ('Other');
...
INSERT INTO settings (company_name, currency, default_member_due, timezone)
  VALUES ('ICT Solutions', 'USD', 10.00, 'Africa/Mogadishu');