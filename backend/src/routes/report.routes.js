...
router.get('/customer-statement', reportController.customerStatement);
router.get('/project-statement', reportController.projectStatement);
router.get('/expense-statement', reportController.expenseStatement);
router.get('/salary-statement', reportController.salaryStatement);
