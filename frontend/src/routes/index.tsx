...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "projects", element: <Navigate to="/projects/one-time" replace /> },
      { path: "projects/one-time", element: withLoader(ProjectsPage) },
      ...
      { path: "invoices/:id", element: withLoader(InvoiceDetailPage) },
      ...
      { path: "trash", element: withLoader(TrashPage) },
